...
<<VER 2>>
2.1
+ Nambah kata "ohayou", dikalimat maichan
+ Nambah beberapa nama dan kata kasar
2.0
...
+ Masukin keyword dasar';
                    ...
                    elseif (strstr($text, 'anjing') or strstr($text, 'goblok') or strstr($text, 'tolol') or strstr($text, 'bangsat') or strstr($text, 'kontol') or strstr($text, 'titit') or strstr($text, 'memek') or strstr($text, 'ngentot') or strstr($text, 'peler') or strstr($text, 'setan') or strstr($text, 'babi') or strstr($text, 'kentod') or strstr ($text, 'tai') or strstr($text, 'goblog')) {
                    ...
                    elseif (strstr($text, 'maichan') or strstr($text, 'mai-chan') or strstr($text, 'mai chan')) {
                        ...
                        if (strstr($text, 'bodo') or strstr($text, 'jahat') or strstr($text, 'jelek') or strstr($text, 'bau') or strstr($text, 'lacur') or strstr($text, 'bego') or strstr($text, 'jablay')) {
